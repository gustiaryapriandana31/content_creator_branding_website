...
const Contact = () => {
    return (
      <main className="bg-gradient-to-bl from-gray-950 via-gray-950 to-sky-800  min-h-screen p-10">
        ...
        <section className="relative flex flex-col md:flex-row gap-8 items-center">
          <img
            ...
            className="absolute md:top-3 top-6 md:left-56 -right-2 md:w-36 md:h-36 w-32 h-32 rounded-full shadow-md shadow-green-200"
          />

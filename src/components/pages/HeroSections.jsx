      ...
      <main className="md:px-32 md:h-screen bg-gray-950">
        ...
        <section className="flex md:flex-row items-center flex-col">
          ...
          <div className="text-center md:text-start order-2 md:order-1 opacity-90 md:basis-3/5 px-10 font-poppins">
            <h3 className="text-lg text-white font-semibold mt-10 md:mt-12 mb-2 font-audiowide md:block">
              Digital Creator
            </h3>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity:1, transition:{delay:1.4, duration:0.2, ease:"easeInOut"}, }} className="md:order-2 order-1 md:basis-2/5 group rounded-full mix-blend-lighten pt-16">
            ...
            />
            <motion.svg className="absolute top-6 right-14 md:top-36 md:right-2 w-2/3 h-2/3 md:w-1/2 md:h-1/2" fill="transparent" viewBox="0 0 506 506" xmlns="http://www.w3.org/2000/svg">

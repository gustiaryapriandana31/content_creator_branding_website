    ...
    <footer className="relative bg-gray-900 text-white">
      <div className="grid lg:grid-cols-4 gap-7 sm:grid-cols-1 p-20">
        ...
        <div>
          ...
          <Link to="/donuts" className="block my-4 list-none">
            Donuts
          </Link>
          <Link to="/" className="block my-4 list-none">
            Reviews
        ...
        <div className="mb-4 md:mb-0">
          <h2 className="text-xl font-bold font-roboto text-slate-800 py-2 uppercase">
            Contact
          </h2>
      ...
      <div className="text-center text-sm py-4 bg-gray-700 border-t-2 border-gray-500 md:text-lg">
        <p className="md:w-full w-3/4 mx-auto">
          &copy; 2024 DODONUTS. Arya Priandana . All rights reserved.
        </p>
      </div>
    </footer>
  );
